...
(function () {
    ...
    angular.module('starter').controller('myPostsCtrl', ['$scope','$state', '$ionicModal','$http','$rootScope', 'httpService', '$location', '$ionicScrollDelegate','$ionicPopup','$timeout', myPostsCtrl]);

    function myPostsCtrl($scope, $state, $ionicModal, $http, $rootScope, httpService, $location, $ionicScrollDelegate, $ionicPopup, $timeout) {
      ...
      $scope.loadPost = function(){
            ...
            httpService.makecall($rootScope.baseUrl+ '/getMyPosts', 'POST', obj).then(function(response){
